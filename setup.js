...
module.exports = function() {
    ...
    post.init(admin.getAdminObject(), category.getCategoryObject(), subcategory.getSubCategoryObject(), writer.getWriterObject(), views.getViewsObject(), deviceid.getDeviceIdObject())
}